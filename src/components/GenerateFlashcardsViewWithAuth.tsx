...
const GenerateFlashcardsViewWithAuth: React.FC = () => {
  ...
  const { sourceText, flashcards, isGenerating, isSaving, errors } = viewState;
  return (
      ...
      {flashcards.length > 0 && (
        <>
          ...
          <div className="relative">
            ...
            <GeneratedFlashcardsList flashcards={flashcards} onFlashcardAction={actions.updateFlashcardStatus} />
          </div>
          ...
          <div className="relative">
            ...
            <SaveActionsSection flashcards={flashcards} onSaveAll={actions.saveFlashcards} isSaving={isSaving} />
          </div>
        </>
      )}{" "}
