...
const SaveActionsSection: React.FC<SaveActionsSectionProps> = ({ flashcards, onSaveAll, isSaving }) => {
      ...
      <CardContent className="p-6">
        <div className="space-y-4">
          ...
          <div className="text-center">
            ...
            <p className="text-sm text-gray-600">Sprawdź stan swoich fiszek i zapisz wybrane</p>
          </div>
            ...
            {canSave ? (
              ...
              <div className="text-center space-y-3">
                <div className="flex items-center justify-center space-x-2">
                  ...
                  <span className="text-sm text-gray-600">Brak fiszek do zapisu</span>
                </div>
