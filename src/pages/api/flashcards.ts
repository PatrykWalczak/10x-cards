...
const createFlashcardSchema = z.object({
  front: z.string().min(1, "Front fiszki nie może być pusty").max(200, "Front fiszki nie może przekraczać 200 znaków"),
  back: z.string().min(1, "Tył fiszki nie może być pusty").max(500, "Tył fiszki nie może przekraczać 500 znaków"),
  ...
  try {
    ...
    try {
      ...
      if (
        ...
        "code" in dbError &&
        (dbError as { code: string }).code === "23503"
      ) {
